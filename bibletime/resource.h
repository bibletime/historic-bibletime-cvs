...
#define IDK_PRESENTER_NEXT_BOOK		CTRL+Key_B
#define IDK_PRESENTER_PREVIOUS_BOOK	CTRL+SHIFT+Key_B
#define IDK_PRESENTER_NEXT_ENTRY	0
...
//#define LOAD_SMALL_ICON(name)		KGlobal::instance()->iconLoader()->loadIcon(name, KIcon::Small,16)
