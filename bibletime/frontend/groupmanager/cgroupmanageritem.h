...
public:
	...
	/**
	 	...
	 	*/
	CGroupManagerItem( CGroupManager *parent, const QString& caption,const QString& modulename, CModuleInfo *module_info, CKey* bookmarkKey = 0, CGroupManagerItem::itemType Type = CGroupManagerItem::Module );
	/**
	 	...
	 	* @param Type The type of the created item. May ba Module, Bookmark or Group. If you leave out the parameter it will be Module by default.
	 	*/	
	CGroupManagerItem( CGroupManagerItem *parent, const QString& caption, const QString& modulename, CModuleInfo *module_info, CKey* bookmarkKey = 0, CGroupManagerItem::itemType Type = CGroupManagerItem::Module );
	/**
...
private:
  ...
  /**
   	...
   	*/
  virtual void init( const QString& caption, const QString& modulename, CModuleInfo *module_info,CKey* bookmarkKey, CGroupManagerItem::itemType Type);
  /**
