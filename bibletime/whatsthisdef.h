...
#define WT_FILE_QUIT WT( TT_FILE_QUIT, i18n("This will terminate BibleTime."))
...
#define WT_GM_RESET	WT(TT_GM_RESET, i18n("This will reset the groupmanager<BR>All bookmarks and groups will be deleted and the default groups will be restored."))

#define WT_VIEW_GROUPMANAGER WT(TT_VIEW_GROUPMANAGER, i18n("This will show or hide the groupmanager depending on current state."))
...
#define WT_VIEW_STRONGS WT(TT_VIEW_STRONGS, i18n("This will show or hide the strong numbers in texts depending on current state."))

#define WT_WINDOW_TILE WT(TT_WINDOW_TILE, i18n("This will arrange the opened presenter windows in a tile pattern."))
#define WT_WINDOW_AUTO_TILE WT( TT_WINDOW_AUTO_TILE, i18n("If this is enabled the opened presenter windows will automatically tiled."))
#define WT_WINDOW_CASCADE WT( TT_WINDOW_CASCADE, i18n("This will arrange the opened presenter windows in a cascade pattern."))
#define WT_WINDOW_AUTO_CASCADE WT( TT_WINDOW_AUTO_CASCADE, i18n("If this is enabled opened presenter windows will automatically cascaded."))
#define WT_WINDOW_CLOSE_ALL WT( TT_WINDOW_CLOSE_ALL, i18n("This will close all opened presenter windows."))
...
#define WT_HELP_WHATSTHIS WT(TT_HELP_WHATSTHIS, i18n("This will switch into the \"Whats this?\" mode."))
...
#define WT_GM_WIDGET WT(TT_GM_WIDGET, i18n("This is the groupmanager of BibleTime.<BR>Use it to manage the installed modules, work with bookmarks, to open presenters etc.."))
#define WT_GM_NEW_PRESENTER WT(TT_GM_NEW_PRESENTER, i18n("This will open a new presenter window for the selected module."))
#define WT_GM_NEW_GROUP WT(TT_GM_NEW_GROUP, i18n("This will create a new group.<BR> If you pressed the right mouse button on a group the new group will be the subitem of it.<BR>Otherwise you will create a toplevel group."))
#define WT_GM_CHANGE_GROUP WT(TT_GM_CHANGE_GROUP, i18n("This will change the properties of the selected group."))
#define WT_GM_NEW_BOOKMARK WT(TT_GM_NEW_BOOKMARK, i18n("This will create a new bookmark. The current key of the activated presenter<BR>will be used to craete the bookmark."))
...
#define WT_GM_PRINT_BOOKMARK WT(TT_GM_PRINT_BOOKMARK, i18n("Use this to print the bookmark. The key, the description and the text of the key will be printed."))
...
#define WT_PRESENTER_BIBLE_WIDGET WT(TT_PRESENTER_BIBLE_WIDGET, i18n("This is the presenter where bibles are shown."))
#define WT_PRESENTER_COMMENTARY_WIDGET WT(TT_PRESENTER_COMMENTARY_WIDGET, i18n("This is the presenter where commentaries are shown."))
#define WT_PRESENTER_LEXICON_WIDGET WT(TT_PRESENTER_LEXICON_WIDGET, i18n("This is the presenter where lexicons are shown."))

#define WT_PRESENTER_NEXT_VERSE WT(TT_PRESENTER_NEXT_VERSE, i18n("This will show or highlight the next verse depending on the type of presenter."))
#define WT_PRESENTER_PREVIOUS_VERSE WT(TT_PRESENTER_PREVIOUS_VERSE, i18n("This will show or highlight the previous verse depending on the type of presenter."))
#define WT_PRESENTER_NEXT_CHAPTER WT(TT_PRESENTER_NEXT_CHAPTER, i18n("This will show or highlight the next chapter depending on the type of presenter."))
#define WT_PRESENTER_PREVIOUS_CHAPTER WT(TT_PRESENTER_NEXT_CHAPTER, i18n("This will show or highlight the previous chapter depending on the type of presenter."))
...
#define WT_PRESENTER_AUTO_SCROLL WT(TT_PRESENTER_AUTO_SCROLL, i18n("If this is activated the current presenter will scroll with the other autoscrolling-enabled presenters."))
...
#define WT_SD_SCOPE_NO_SCOPE WT(TT_SCOPE_NO_SCOPE, i18n("Select this if you want to search the whole module(s)."))
#define WT_SD_SCOPE_LAST_RESULT WT(TT_SCOPE_LAST_RESULT, i18n("Select this if you want to use last search result of a module<BR>for the search scope of the module."))
#define WT_SD_SCOPE_SET_BOUNDS WT(TT_SCOPE_SET_BOUND, i18n("Select this if you want to specify own search scopes."))
#define WT_SD_SCOPE_ADD_SCOPE WT(TT_SCOPE_ADD_SCOPE, i18n("Use this button to add the edited scope to the selected module."))
#define WT_SD_SCOPE_DELETE_SCOPE WT(TT_SCOPE_DELETE_SCOPE, i18n("Use this button o delete the currently selected scope."))

#define WT_SD_RESULT_RESULT_VIEW WT(TT_SD_RESULT_VIEW, i18n("This contains the found items of the searched module(s)"))
#define WT_SD_RESULT_PREVIEW WT(TT_SD_RESULT_PREVIEW, i18n("This text box contains the text of the selected verse."))
...
#define WT_OD_FONTS_PRESENTER WT(TT_OD_FONTS_PRESENTER, i18n("This font will be used as general font in all presenters."))
...
#define WT_OD_COLORS_BACKGROUND WT(TT_OD_COLORS_BACKGROUND, i18n("This is the background color used in presenters."))
#define WT_OD_COLORS_NORMAL_TEXT WT(TT_OD_COLORS_NORMAL_TEXT, i18n("This is the color of normal text used in presenters."))
#define WT_OD_COLORS_VERSENUMBER WT(TT_OD_COLORS_VERSENUMBER, i18n("This is the color of versenumbers used in presenters."))
#define WT_OD_COLORS_CURRENT_VERSE WT(TT_OD_COLORS_CURRENT_VERSE, i18n("This is the color of the highlighted verse used in presenters."))
...
#define WT_PD_GENERAL_PRINTER_LIST WT(TT_PD_GENERAL_PRINTER_LIST, i18n("This is the list of available printers on your system.<BR>Please select the printer you want to use."))
#define WT_PD_GENERAL_PRINT_TO_FILE WT(TT_PD_GENERAL_PRINT_TO_FILE, i18n("Print into a postrscript file on disk."))
#define WT_PD_GENERAL_BROWSE_FILE WT(TT_PD_GENERAL_BROWSE_FILE, i18n("Browse for the file you want to print print to."))
