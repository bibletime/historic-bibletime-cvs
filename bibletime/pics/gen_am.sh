...
for I1 in `ls -d *color`; do
  ...
  echo "dnl this Makefile.am was automatically generated by gen_am.sh" >  $I1/Makefile.am
  echo "dnl please do not edit this file but rather change the script" >> $I1/Makefile.am
  echo " "               >> $I1/Makefile.am
