...
#define IDK_FILE_NEW_WINDOW							CTRL+Key_W

#define IDK_GM_RESET							CTRL+ALT+Key_R
#define IDK_GM_SEARCH							CTRL+ALT+Key_F
#define IDK_GM_ITEMS_DELETE				CTRL+ALT+Key_D
#define IDK_GM_MODULES_SEARCH			CTRL+ALT+Key_S
...
#define IDK_PRESENTER_AUTOSCROLL				CTRL+ALT+Key_S
...
#define IDK_WINDOW_CLOSE_ALL						CTRL+SHIFT+Key_A
